...
public class ReadActivity extends AppCompatActivity {
    ...
    public void startCamera() {
        ...
        Uri photoUri = getUriForFile(this, getApplicationContext().getPackageName() + ".provider", getCameraFile());
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                ((MainActivity)MainActivity.mContext).tts.speak(text,TextToSpeech.QUEUE_FLUSH, null);
            }
        }
    }
    ...
    private static String convertResponseToString(BatchAnnotateImagesResponse response) {
        ...
        message.delete(message.length()-count*2,message.length());
